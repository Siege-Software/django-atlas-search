...
class TestAtlasSearchCharField(TestCase):
    def setUp(self):
    ...
    def test_atlas_mapping(self):
        title_mapping = SongCollection.title.get_atlas_mapping()
        self.assertIsNotNone(title_mapping)
        self.assertEqual(title_mapping["type"], "string")
        self.assertEqual(title_mapping["analyzer"], "lucene.standard")
    ...
    def test_value_method(self):
        ...
        optional_field = fields.AtlasSearchCharField(value="name", optional=True)
        self.assertEqual(optional_field.value(obj=self.song), "")

        with self.assertRaises(AttributeError):
            invalid_field = fields.AtlasSearchCharField(value="invalid_field")
...
class TestAtlasSearchIntegerMixin(TestCase):
    def setUp(self):
        self.genre = Genre.objects.create(name="genre1")
        self.song = Song.objects.create(
            title="New Song",
    ...
    def test_value_method(self):
        ...
        views = fields.AtlasSearchIntegerField(value="number_of_views", optional=True)
        self.assertIsNone(views.value(obj=self.song))

        self.song.number_of_views = "Wrong type"
        with self.assertRaises(ValueError):
            views.value(obj=self.song)


class TestAtlasSearchDecimalField(TestCase):
    def setUp(self):
        self.genre = Genre.objects.create(name="genre1")
        self.song = Song.objects.create(
            title="New Song",
    ...
    def test_value_method(self):
        price = fields.AtlasSearchDecimalField(value="price", optional=True)
        self.assertIsNone(price.value(obj=self.song))
...
class TestAtlasSearchDateTimeFieldBase(TestCase):
    def setUp(self):
        self.genre = Genre.objects.create(name="genre1")
        self.song = Song.objects.create(
            title="New Song",
    ...
    def test_value_method(self):
        optional_date = fields.AtlasSearchDateField(value="optional_field", optional=True)
        self.assertIsNone(optional_date.value(obj=self.song))

        release_date_timestamp = fields.AtlasSearchDateField(
            value="release_date_timestamp"
        )
        release_date_timestamp_value = release_date_timestamp.value(obj=self.song)
        # Atlas Search date fields return datetime objects, not timestamps
        self.assertTrue(isinstance(release_date_timestamp_value, (date, datetime)))

    def test_date_field(self):
        release_date = SongCollection.release_date
        release_date_value = release_date.value(obj=self.song)
        # Atlas Search handles dates as datetime objects
        self.assertTrue(isinstance(release_date_value, (date, datetime)))
    ...
    def test_time_field(self):
        release_time = fields.AtlasSearchTimeField(value="release_time")
    ...
    def test_datetime_field(self):
        created_at = fields.AtlasSearchDateTimeField(value="created_at")
...
class TestAtlasSearchJSONField(TestCase):
    def setUp(self):
        self.genre = Genre.objects.create(name="genre1")
        self.song = Song.objects.create(
            title="New Song",
    ...
    def test_value_method(self):
        extra_info = fields.AtlasSearchJSONField(value="extra_info")
...
class TestAtlasSearchArrayField(TestCase):
    def setUp(self):
        self.genre = Genre.objects.create(name="genre1")
